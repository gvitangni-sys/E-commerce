...
(function ($) {
  ...
  $(
    ".tp-header-side-menu > nav > ul > li a, .offcanvas__category > nav > ul > li a"
  ).each(function (i, v) {
  ...
  if ($(".main-menu.menu-style-3 > nav > ul").length > 0) {
    $(".main-menu.menu-style-3 > nav > ul").append(
      `<li id="marker" class="tp-menu-line"></li>`
    );
  }
  ...
  if ($("#tp-offcanvas-lang-toggle").length > 0) {
    window.addEventListener("click", function (e) {
      if (
        document.getElementById("tp-offcanvas-lang-toggle").contains(e.target)
      ) {
  ...
  if ($("#tp-offcanvas-currency-toggle").length > 0) {
    window.addEventListener("click", function (e) {
      if (
        document
          .getElementById("tp-offcanvas-currency-toggle")
          .contains(e.target)
      ) {
  ...
  if ($("#tp-header-currency-toggle").length > 0) {
    window.addEventListener("click", function (e) {
      if (
        document.getElementById("tp-header-currency-toggle").contains(e.target)
      ) {
  ...
  // 04. Menu Controls JS
  if (
    $(".tp-category-menu-content").length &&
    $(".tp-category-mobile-menu").length
  ) {
  ...
  function tp_color_settings() {
    ...
    function tp_set_color(tp_color_scheme) {
      ...
      document
        .querySelector(":root")
        .style.setProperty("--tp-theme-primary", tp_color_scheme);
    ...
    function tp_init_color() {
      ...
      if (defaultColor !== setColor) {
        document
          .querySelector(":root")
          .style.setProperty("--tp-theme-primary", setColor);
        ...
        document
          .querySelector(":root")
          .style.setProperty("--tp-theme-primary", defaultColor);
    ...
    themeButtons.forEach((color) => {
      color.addEventListener("click", () => {
        ...
        document
          .querySelector(":root")
          .style.setProperty("--tp-theme-primary", datacolor);
        document.getElementById("tp-theme-color-label").style.backgroundColor =
          datacolor;
  ...
  $(".tp-slider-nav-active").slick({
    ...
    arrows: false,
    prevArrow:
      '<button type="button" class="tp-slick-prev"><i class="fa-solid fa-arrow-up"></i></button>',
    nextArrow:
      '<button type="button" class="tp-slick-next"><i class="fa-solid fa-arrow-down"></i></button>',
    centerMode: false,
    focusOnSelect: true,
    rtl: false,
  });
